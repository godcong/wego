...
const MMPAYSPTRANS_QUERY_BANK_URL_SUFFIX = "/mmpaysptrans/query_bank"
const MMPAYSPTRANS_PAY_BANK_URL_SUFFIX = "/mmpaysptrans/pay_bank"
const AUTHCODETOOPENID_URL_SUFFIX = "/tool/authcodetoopenid"
