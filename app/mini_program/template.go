...
func (t *Template) List(offset, count int) util.Map {
	return t.GetClient().HttpPostJson(t.client.Link(core.TEMPLATE_LIBRARY_LIST_URL_SUFFIX), util.Map{"offset": offset, "count": count}, nil).ToMap()
}

func (t *Template) Get(id string) util.Map {
	return t.GetClient().HttpPostJson(t.client.Link(core.TEMPLATE_LIBRARY_GET_URL_SUFFIX), util.Map{"id": id}, nil).ToMap()
}

func (t *Template) Delete(templateId string) util.Map {
	return t.GetClient().HttpPostJson(t.client.Link(core.TEMPLATE_DEL_URL_SUFFIX), util.Map{"template_id": templateId}, nil).ToMap()
}

func (t *Template) GetTemplates(offset, count int) util.Map {
	return t.GetClient().HttpPostJson(t.client.Link(core.TEMPLATE_LIST_URL_SUFFIX), util.Map{"offset": offset, "count": count}, nil).ToMap()
}
