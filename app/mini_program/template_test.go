...
//}
//
//func testTemplate_GetIndustry(t *testing.T, template *mini_program.Template) {
//	rlt := template.GetIndustry()
//	t.Log(rlt.ToString())
//}
//
//func testTemplate_Add(t *testing.T, template *mini_program.Template) {
//	rlt := template.Add("TM00015")
//	t.Log(rlt.ToString())
//}
//
//func testTemplate_DelAllPrivate(t *testing.T, template *mini_program.Template) {
//	rlt := template.GetAllPrivate()
//	t.Log(rlt.ToString())
//}
//
//func testTemplate_GetAllPrivate(t *testing.T, template *mini_program.Template) {
//	rlt := template.DelAllPrivate("vc2ekfQmEP9qE9eBW9gGWaUrsLvztC9XOeB-cftLroo")
//	t.Log(rlt.ToString())
//}

func testTemplate_Send(t *testing.T, template *mini_program.Template) {
